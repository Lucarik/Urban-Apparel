...
<body class="decal">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $query = 'SELECT `Password` FROM `Client` WHERE `Username` = "'.$user.'"';
        ...
        $profile_statement = "SELECT * FROM Client WHERE Username = '" . mysqli_real_escape_string($db, $_SESSION['login_user']) . "' LIMIT 1;";
