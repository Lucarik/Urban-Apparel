...
<body class="decal">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        */
        ...
        $query = 'SELECT `Password` FROM `Owner` WHERE `Username` = "'.$user.'"';
        $result = $db->query($query);
        ...
        $profile_statement = "SELECT * FROM Owner WHERE Username = '" . mysqli_real_escape_string($db, $_SESSION['login_user']) . "' LIMIT 1;";
